		...
		<div class="inicio">
			<div class="fondo">
				<div class="destacado" id="destacado">
					<video src="/assets/video/home/fondo_top_categorias.mp4" autoplay loop muted ref="video_top">
				...
				<section id="clasificados" class="clasificados_destacados w-full relative">
					<video src="/assets/video/home/fondo_top3.mp4" class="absolute w-full" autoplay loop muted ref="video_top3">
...
export default {
	...
	async created() {
		...
		this.$nextTick(() => {
			this.$refs.video_top.play().catch((e) => console.log("Video top bloqueado:", e));
			this.$refs.video_top.volume = 1;
			this.$refs.video_top3.play();
		});
	},
	unmounted() {
